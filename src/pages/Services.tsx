...
const serviceItems = [
  {
    ...
    body: "Workflows que conectam ferramentas e eliminam tarefas manuais e repetitivas em qualquer área da operação. Vendas, marketing, financeiro, logística, RH, cada processo é mapeado, modelado e automatizado com gatilhos, validações e regras de negócio próprias da sua empresa, garantindo que o resultado seja consistente e auditável a cada execução. <br> A base de qualquer automação eficaz é a integração entre os sistemas envolvidos. Quando ERPs, CRMs, ferramentas de marketing e canais de atendimento operam de forma descentralizada, surgem retrabalho, dados duplicados e decisões baseadas em informação incompleta. Cada projeto começa com uma consultoria técnica para avaliar a viabilidade de integração entre os sistemas envolvidos. A partir desse diagnóstico, é definida a arquitetura adequada para o seu negócio.<br/>",
